...
# This is the restarter(after it fails) for catalog server  which is responsible for all the actions related to the db
...
def heartbeat_catalog(catalogip, heartbeat_port):
    print("heartbeat port listening at:", heartbeat_port)

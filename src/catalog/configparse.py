...
def parse():
    ...
    parser.add_argument('--z', metavar='z', type=str, help='config file', default="0")
    ...
    return order_ip1, order_port1, order_ip2, order_port2, catalog_ip1, catalog_port1, catalog_ip2, catalog_port2, frontend_ip, frontend_port, args.i,args.z
